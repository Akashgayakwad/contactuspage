        ...
        <div class="row">
            <div class="col-sm-offset-1 col-sm-10 contactForm">
                ...
                <?php
                    ...
                    if(isset($_POST["submit"])){
                        ...
                        if($errors){
                            ...
                            $subject="Contact";
                            $message="<p>Name: ".$name."</p><p>Email: ".$email."</p><p>Message:</p><p><strong>".$message."</strong></p>"; 
                ...
                '<form method="post">
                    ...
                    <input type="text" name="name" id="name" placeholder="Name" class="form-control" value="'.$_POST['name'].'">
                    <label for="email">Email:</label>
                    <input type="text" name="email" id="email" placeholder="Email" class="form-control" value="'.$_POST['email'].'">
